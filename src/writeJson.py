...
source_id[key]['model_component']['atmos']['description'] = 'GFDL-AM4.1 (Cubed-sphere (c96) - 1 degree nominal horizontal resolution; 360x180 longitude/latitude; 33 levels; top level 1 hPa)'
...
source_id[key]['model_component']['ocean']['description'] = 'GFDL-MOM6 (tripolar - nominal 0.25 deg latitude/longitude; 1440x720 longitude/latitude; 75 levels; top grid cell 0-2 m)'
...
source_id[key]['model_component']['aerosol']['nominal_resolution'] = '100 km'
source_id[key]['model_component']['atmos'] = {}
source_id[key]['model_component']['atmos']['description'] = 'GFDL-AM4.1 (Cubed-sphere (c96) - 1 degree nominal horizontal resolution; 360x180 longitude/latitude; 49 levels; top level 1 Pa)'
source_id[key]['model_component']['atmos']['nominal_resolution'] = '100 km'
source_id[key]['model_component']['atmosChem'] = {}
...
source_id[key]['model_component']['landIce']['nominal_resolution'] = '100 km'
source_id[key]['model_component']['ocean'] = {}
source_id[key]['model_component']['ocean']['description'] = 'GFDL-MOM6 (tripolar - nominal 0.5 deg latitude/longitude; 720x360 longitude/latitude; 75 levels; top grid cell 0-2 m)'
...
source_id[key]['model_component']['ocean'] = {}
source_id[key]['model_component']['ocean']['description'] = 'GFDL-MOM4p1 (tripolar - nominal 1 deg latitude/longitude; 360x200 longitude/latitude; 50 levels; top grid cell 0-10 m)'
