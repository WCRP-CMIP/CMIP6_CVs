from denver import load_json, save_json, remove_json_files
import os
...
def main():
    ...
    create_collection("frequency","frequency",False) # ids in universe are not lowered
