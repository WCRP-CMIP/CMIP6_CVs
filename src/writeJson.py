...
source_id[key]['model_component']['aerosol']['description'] = 'INCA v6 NMHC-AER-S'
source_id[key]['model_component']['aerosol']['native_nominal_resolution'] = '500 km'
source_id[key]['model_component']['atmos'] = {}
source_id[key]['model_component']['atmos']['description'] = 'LMDZ (APv5; 96 x 96 longitude/latitude; 39 levels; top level 80000 m)'
source_id[key]['model_component']['atmos']['native_nominal_resolution'] = '500 km'
source_id[key]['model_component']['atmosChem'] = {}
source_id[key]['model_component']['atmosChem']['description'] = 'INCA v6 NMHC-AER-S'
source_id[key]['model_component']['atmosChem']['native_nominal_resolution'] = '500 km'
source_id[key]['model_component']['land'] = {}
source_id[key]['model_component']['land']['description'] = 'ORCHIDEE (IPSLCM5A2.1, Water/Carbon/Energy mode)'
